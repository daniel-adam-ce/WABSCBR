...
module DE2_115_Qsys_mm_interconnect_0 (
	...
	wire  [101:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> cpu_0_data_master_agent:rp_data
	wire          rsp_mux_src_ready;                                                           // cpu_0_data_master_agent:rp_ready -> rsp_mux:src_ready
	wire    [3:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> cpu_0_data_master_agent:rp_channel
	...
	wire  [102:0] cpu_0_debug_mem_slave_agent_rf_source_data;                                  // cpu_0_debug_mem_slave_agent:rf_source_data -> cpu_0_debug_mem_slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] cpu_0_debug_mem_slave_agent_rsp_fifo_out_data;                               // cpu_0_debug_mem_slave_agent_rsp_fifo:out_data -> cpu_0_debug_mem_slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_001_src_data;                                                        // cmd_mux_001:src_data -> cpu_0_debug_mem_slave_agent:cp_data
	wire          cmd_mux_001_src_ready;                                                       // cpu_0_debug_mem_slave_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [3:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> cpu_0_debug_mem_slave_agent:cp_channel
	...
	wire  [102:0] mm_clock_crossing_bridge_0_s0_agent_rf_source_data;                          // mm_clock_crossing_bridge_0_s0_agent:rf_source_data -> mm_clock_crossing_bridge_0_s0_agent_rsp_fifo:in_data
	...
	wire  [102:0] mm_clock_crossing_bridge_0_s0_agent_rsp_fifo_out_data;                       // mm_clock_crossing_bridge_0_s0_agent_rsp_fifo:out_data -> mm_clock_crossing_bridge_0_s0_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> mm_clock_crossing_bridge_0_s0_agent:cp_data
	...
	wire  [102:0] sdram_0_s1_agent_rf_source_data;                                             // sdram_0_s1_agent:rf_source_data -> sdram_0_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] sdram_0_s1_agent_rsp_fifo_out_data;                                          // sdram_0_s1_agent_rsp_fifo:out_data -> sdram_0_s1_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                       // cmd_mux_003:src_valid -> sdram_0_s1_agent:cp_valid
	wire  [101:0] cmd_mux_003_src_data;                                                        // cmd_mux_003:src_data -> sdram_0_s1_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                       // sdram_0_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [3:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> sdram_0_s1_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                               // cmd_mux_003:src_startofpacket -> sdram_0_s1_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                 // cmd_mux_003:src_endofpacket -> sdram_0_s1_agent:cp_endofpacket
	wire          cpu_0_data_master_agent_cp_valid;                                            // cpu_0_data_master_agent:cp_valid -> router:sink_valid
	wire  [101:0] cpu_0_data_master_agent_cp_data;                                             // cpu_0_data_master_agent:cp_data -> router:sink_data
	...
	wire  [101:0] cpu_0_instruction_master_agent_cp_data;                                      // cpu_0_instruction_master_agent:cp_data -> router_001:sink_data
	...
	wire          cpu_0_debug_mem_slave_agent_rp_valid;                                        // cpu_0_debug_mem_slave_agent:rp_valid -> router_003:sink_valid
	wire  [101:0] cpu_0_debug_mem_slave_agent_rp_data;                                         // cpu_0_debug_mem_slave_agent:rp_data -> router_003:sink_data
	wire          cpu_0_debug_mem_slave_agent_rp_ready;                                        // router_003:sink_ready -> cpu_0_debug_mem_slave_agent:rp_ready
	wire          cpu_0_debug_mem_slave_agent_rp_startofpacket;                                // cpu_0_debug_mem_slave_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          cpu_0_debug_mem_slave_agent_rp_endofpacket;                                  // cpu_0_debug_mem_slave_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire  [101:0] mm_clock_crossing_bridge_0_s0_agent_rp_data;                                 // mm_clock_crossing_bridge_0_s0_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] sdram_0_s1_agent_rp_data;                                                    // sdram_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [101:0] router_001_src_data;                                                         // router_001:src_data -> cpu_0_instruction_master_limiter:cmd_sink_data
	wire          router_001_src_ready;                                                        // cpu_0_instruction_master_limiter:cmd_sink_ready -> router_001:src_ready
	wire    [3:0] router_001_src_channel;                                                      // router_001:src_channel -> cpu_0_instruction_master_limiter:cmd_sink_channel
	...
	wire  [101:0] cpu_0_instruction_master_limiter_cmd_src_data;                               // cpu_0_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire    [3:0] cpu_0_instruction_master_limiter_cmd_src_channel;                            // cpu_0_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire  [101:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> cpu_0_instruction_master_limiter:rsp_sink_data
	wire          rsp_mux_001_src_ready;                                                       // cpu_0_instruction_master_limiter:rsp_sink_ready -> rsp_mux_001:src_ready
	wire    [3:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> cpu_0_instruction_master_limiter:rsp_sink_channel
	...
	wire  [101:0] cpu_0_instruction_master_limiter_rsp_src_data;                               // cpu_0_instruction_master_limiter:rsp_src_data -> cpu_0_instruction_master_agent:rp_data
	...
	wire    [3:0] cpu_0_instruction_master_limiter_cmd_valid_data;                             // cpu_0_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	wire          sdram_0_s1_agent_rdata_fifo_src_valid;                                       // sdram_0_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] sdram_0_s1_agent_rdata_fifo_src_data;                                        // sdram_0_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          sdram_0_s1_agent_rdata_fifo_src_ready;                                       // avalon_st_adapter_003:in_0_ready -> sdram_0_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                           // avalon_st_adapter_003:out_0_valid -> sdram_0_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                            // avalon_st_adapter_003:out_0_data -> sdram_0_s1_agent:rdata_fifo_sink_data
	...
	DE2_115_Qsys_mm_interconnect_0_router_003 router_003 (
	...
	DE2_115_Qsys_mm_interconnect_0_router_003 router_005 (
	...
	DE2_115_Qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_100_clk_clk),                         //       clk.clk
		.reset               (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_Qsys_mm_interconnect_0_cmd_mux_001 cmd_mux_003 (
		.clk                 (clk_100_clk_clk),                         //       clk.clk
		.reset               (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	DE2_115_Qsys_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_100_clk_clk),                         //       clk.clk
		.reset              (cpu_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
